...
class SSHPOC(POCBase):
	...
	def _verify(self):
		...
		payload = "弱口令"
		username = ["root","admin",]
		password = ["","toor","1234","netentsec","netentsec@360.net","admin@qihoo.net","360tianji","123456","admin","Admin","ADMIN","admin123","Admin123","root","root123","123.com"'123456','admin','root','password','123123','123','1','',
